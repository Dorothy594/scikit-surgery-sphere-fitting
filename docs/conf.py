...
# -*- coding: utf-8 -*-
#
# scikit-surgery-sphere-fitting documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under scikit-surgery-sphere-fitting
modindex_common_prefix = [
    'scikit-surgery-sphere-fitting.'
]

# General information about the project.
project = u'scikit-surgery-sphere-fitting'
copyright = u"2022, University College London"
author = u'Ma Zhiyu'
...
# The short X.Y version.
# version = scikit-surgery-sphere-fitting.__version__
# The full version, including alpha/beta/rc tags.
# release = scikit-surgery-sphere-fitting.__version__
...
htmlhelp_basename = 'scikit-surgery-sphere-fittingdoc'
...
latex_documents = [
    ('index', 'scikit-surgery-sphere-fitting.tex',
     u'scikit-surgery-sphere-fitting Documentation',
     u'Ma Zhiyu', 'manual'),
]
...
man_pages = [
    ('index', 'scikit-surgery-sphere-fitting',
     u'scikit-surgery-sphere-fitting Documentation',
     [u'Ma Zhiyu'], 1)
]
